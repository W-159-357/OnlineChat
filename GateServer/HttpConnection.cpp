...
void HttpConnection::PreParseGetParam() {
	// 提取 URI  (get_test?key1=vallue1?key2=value2)
...
void HttpConnection::HandleReq()
{
	...
	_response.keep_alive(false);					// 不需要维持长连接
	if (_request.method() == http::verb::get) {		// 处理 get 请求
		...
		_response.set(http::field::server, "GateServer");	// 回复发送方
		WriteResponse();
	}
